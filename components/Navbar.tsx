...
export default function Navbar(){
    ...
    return (
        <main className="h-[96px] relative lg:mt-[40px] ml-[50px] flex items-center justify-between z-20">
            <Image src={'/assets/shared/logo.svg'} width={48} height={48} alt="Logo" className="cursor-pointer"/>
            <div className="w-[32%] hidden lg:flex z-10 h-[1px] absolute bg-white top-[48px] left-[112px] bg-opacity-[0.25]"></div>
            <nav className="w-[64.5%] flex items-center justify-start md:gap-[37px] gap-[4%] h-full bg-white bg-opacity-5 font-barlow-condensed pl-[8%] backdrop-blur-2xl font-normal text-primary md:text-[14px]">
                ...
                (pathname === '/' ? " after:h-1" : "hover:after:h-1 hover:after:opacity-50")}>
                    <span className="font-bold hidden lg:flex">00</span>
                    <p>HOME</p>
                </Link>
                ...
                (pathname === '/Destination' ? " after:h-1" : "hover:after:h-1 hover:after:opacity-50")}>
                    <span className="font-bold hidden lg:flex">01</span>
                    <p>DESTINATION</p>
                </Link>
                ...
                (pathname === '/Crew' ? " after:h-1" : "hover:after:h-1 hover:after:opacity-50")}>
                    <span className="font-bold hidden lg:flex">02</span>
                    <p>CREW</p>
                </Link>
                ...
                (pathname === '/Technology' ? " after:h-1" : "hover:after:h-1 hover:after:opacity-50")}>
                    <span className="font-bold hidden lg:flex">03</span>
                    <p>TECHNOLOGY</p>
                </Link>
            </nav>
        </main>
